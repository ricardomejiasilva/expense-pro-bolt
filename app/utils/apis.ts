...
export const addNotification = async (notification: {
    ...
    return postApi<Notification, typeof notification>(
...
export const attachExistingReceipt = async (
    ...
    try {
        ...
        return postApi<ReceiptTransaction, { transactionId: number; receiptId: number }>(
...
export const uploadFullReceipt = async (
    ...
    // Submit to API
    try {
        return await postApi<FullReceipt, FormData>('api/receipt/UploadFullReceipt', formData, {
            Accept: 'text/plain',
